...
#ifndef PHP_ELASTICSEARCH_H
#define PHP_ELASTICSEARCH_H
...
#	define PHP_ELASTICSEARCH_API __attribute__ ((visibility("default")))
#else
#	define PHP_ELASTICSEARCH_API
#endif
...
/* Always refer to the globals in your function as ELASTICSEARCH_G(variable).
